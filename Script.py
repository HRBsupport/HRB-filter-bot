...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 이제 텔레그램에서도 돈을 벌 수 있습니다.

 전신으로 돈을 벌어야 해 1 그룹이 있어야지.
 그룹이 있는 경우. 그룹에 봇을 추가하여 수익을 올릴 수 있습니다.

 그룹에 멤버가 많을수록 수입은 높아집니다.

 어떻게 그리고 무엇을 해야할지

 1단계: 이 HRB-file-fliter-BOT 봇을 그룹에 관리
...
또한 귀하의 팀은 교육 비디오 컬렉션을 갖게 될 것입니다..."""
...
Also your tutorial will be Added Your Group..."""
    ...
    INDONESIA_INFO = """
Hai <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 


 Sekarang kamu juga bisa mendapatkan uang di Telegram.

 kamu harus memiliki 1 grup untuk mendapatkan uang melalui Telegram.
 Jika kamu memiliki grup, kamu bisa mendapatkan uang dengan menambahkan bot kami ke grupmu.

 Semakin banyak anggota dalam grup mu, semakin tinggi pula penghasilan mu.

 Bagaimana dan apa yang harus dilakukan

 Langkah 1: Kelola bot HRB-FILTER-BOT ini ke grupmu

 Langkah 2: Tambahkan situs web dan API mu

 Tenggat waktu: /shortlink omegalinks.in 4b392f8eb6ad711fbe58

 Tambahkan video

 👇 Bagaimana cara menambahkan 👇

 Tenggat waktu: /set_tutorial Tautan video

 Timmu juga akan melatih pengumpulan video..."""
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 आपके समूह मे जितने अधिक सदस्य होंगे, आपकी आय उतनी ही अधिक होगी।
