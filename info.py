...
API_ID = int(environ.get('API_ID', '16024367'))
API_HASH = environ.get('API_HASH', 'e4d264f7d2608c48102500bff08f5b9c')
BOT_TOKEN = environ.get('BOT_TOKEN', "7801934007:AAE0Uj7i0OhAqCopuhj3ixNSkc_EIccei5w")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5709856741').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002325726762'))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://PXZ:45p7qj4S5p1E9Eo0@cluster0.yd7gp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'HonorsCollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/HonorsFilterBot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/HRBsupport_official')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'HonorsFilterBot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/honorsteam')
...
LANGUAGES = ["malayalam", "mal", "korea", "tam" ,"english", "eng", "hindi", "hin", "indonesia", "tel", "kannada", "kan"]
